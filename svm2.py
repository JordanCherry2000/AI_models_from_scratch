...
def svm_train(X_train, y_train, n_iters, lambda_param, learning_rate):
...
w, b = svm_train(X_train, y_train, n_iters=1000, lambda_param=0.05, learning_rate = 0.001)
svm_predict(X_test, w, b)